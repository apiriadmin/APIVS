...
#define CMU_SWITCH_PACK_DRIVERS_COMMAND                 (61)
#define CMU_GET_CONFIGURATION_COMMAND                   (65)
#define CMU_SWITCH_PACK_DRIVERS_SHORT_STATUS_COMMAND    (67)
...
#define CMU_SWITCH_PACK_DRIVERS_RESPONSE                 (CMU_SWITCH_PACK_DRIVERS_COMMAND + EMFIO_SDLC_RESPONSE_OFFSET)
#define CMU_GET_CONFIGURATION_RESPONSE                   (CMU_GET_CONFIGURATION_COMMAND + EMFIO_SDLC_RESPONSE_OFFSET)
#define CMU_SWITCH_PACK_DRIVERS_SHORT_STATUS_RESPONSE    (CMU_SWITCH_PACK_DRIVERS_SHORT_STATUS_COMMAND + EMFIO_SDLC_RESPONSE_OFFSET)
...
#define CMU_SWITCH_PACK_DRIVERS_COMMAND_SIZE               ((int32_t)14)
#define CMU_SWITCH_PACK_DRIVERS_RESPONSE_SIZE              ((int32_t)178)

#define CMU_GET_CONFIGURATION_COMMAND_SIZE                 ((int32_t)1)
#define CMU_GET_CONFIGURATION_RESPONSE_SIZE                ((int32_t)513)

#define CMU_SWITCH_PACK_DRIVERS_SHORT_STATUS_COMMAND_SIZE  ((int32_t)14)
#define CMU_SWITCH_PACK_DRIVERS_SHORT_STATUS_RESPONSE_SIZE ((int32_t)24)
